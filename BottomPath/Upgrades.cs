    ...
    internal class BUpgrade1 : ModUpgrade<CustomizableTowerClass>
    {
        ...
        public override void ApplyUpgrade(TowerModel towerModel)
        {
            ...
            foreach (var WeaponModel in towerModel.GetWeapons())
            {
                ...
                {
                    ProjectileModel.AddBehavior(new DamageModel("DamageModel_", TotalDamage, -1, false, false, false, BloonProperties.None, BloonProperties.None, false, false));
                }
    ...
    internal class BUpgrade2 : ModUpgrade<CustomizableTowerClass>
    {
        ...
        public override void ApplyUpgrade(TowerModel towerModel)
        {
            ...
            foreach (var WeaponModel in towerModel.GetWeapons())
            {
                ...
                if (!ProjectileModel.HasBehavior<DamageModel>())
                {
                    ProjectileModel.AddBehavior(new DamageModel("DamageModel_", TotalDamage, -1, false, false, true, BloonProperties.None, BloonProperties.None, false, false));
                }
